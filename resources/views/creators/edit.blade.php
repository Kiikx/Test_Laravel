        ...
        <div class="card-body">
            ...
            <form action="{{ route('creators.update', $creator->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $creator->name) }}" required>
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-success">Update Creator</button>
